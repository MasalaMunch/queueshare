...
const maintenanceDelay = require(`./maintenanceDelay.js`);
...
(async () => {
    ...
    const emitActivityMiddleware = (req, res, next) => {
        ...
        maintenanceIntervalId = setInterval(doMaintenance, maintenanceDelay);
    ...
    app.get(``, emitActivityMiddleware, (req, res) => {
