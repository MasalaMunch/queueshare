...
module.exports = class {
    ...
    constructor (onChange = doNothing) {
    ...
    *Changes () {
        ...
        yield* this.ChangesSince(undefined);
    ...
    *ChangesSince (localVersion) {
    ...
    _changify (foreignChange, localVersion = undefined) {
        ...
        foreignChange.versions = Array.from(foreignChange.versions);

        freeze(foreignChange);

    }

    _foreignify (localChange, versions = undefined) {
